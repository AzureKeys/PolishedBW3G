...
CombeeMaleAnimation:   INCLUDE "gfx/pokemon/combee_male/anim.asm"
CombeeFemaleAnimation: INCLUDE "gfx/pokemon/combee_female/anim.asm"
...
SamurottHisuianAnimation: INCLUDE "gfx/pokemon/samurott_hisuian/anim.asm"
