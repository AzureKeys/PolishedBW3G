...
SongInfo:
	...
	song_info "Vs.Unova Wild", ORIGIN_BW, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Vs.Unova Wild Night", ORIGIN_BW, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Spotted! Youngster", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Vs.Unova Trainer", ORIGIN_BW, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Unova Route 4", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_MMMMMM
	song_info "Spotted! Team Plasma", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Vs.Team Plasma", ORIGIN_BW, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Infer Appears", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Vs.Unova Gym Leader", ORIGIN_BW, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Cycling", ORIGIN_XY, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	song_info "Spotted! Lass", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Surfing", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	...
	song_info "Humilau City", ORIGIN_B2W2, COMPOSER_JUNICHI_MASUDA_SHOTA_KAGEYAMA, COMPOSER_SHANTYTOWN
	song_info "Unova Route 1", ORIGIN_BW, COMPOSER_JUNICHI_MASUDA_SHOTA_KAGEYAMA, COMPOSER_SHANTYTOWN
	song_info "Spotted! Ace Trainer", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Spotted! Gentleman", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Spotted! Worker", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Spotted! Psychic", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Spotted! Roughneck", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Spotted! Cyclist", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Spotted! Scientist", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	song_info "Spotted! Twins", ORIGIN_BW, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
