EggSpeciesMovesPointers::
	...
	dw LotadEggSpeciesMoves             ; Lotad
	dw LotadEggSpeciesMoves             ; Lombre
	dw LotadEggSpeciesMoves             ; Ludicolo
	...
	dw BuizelEggSpeciesMoves            ; Buizel
	...
	dw BronzorEggSpeciesMoves           ; Bronzor
	...
	dw SkorupiEggSpeciesMoves           ; Skorupi
	...
	dw SnoverEggSpeciesMoves            ; Snover
	dw SnoverEggSpeciesMoves            ; Abomasnow
	...
	dw NosepassEggSpeciesMoves          ; Probopass
	dw SnoruntEggSpeciesMoves           ; Froslass
	...
	dw OshawottEggSpeciesMoves          ; Samurott (Hisuian Form)
	dw PetililEggSpeciesMoves           ; Lilligant (Hisuian Form)
