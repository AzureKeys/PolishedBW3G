...
NewBaseExpExceptions:
	base_exception SALAMENCE, PLAIN_FORM, 270 ; BST x 50.0% as of gen V (unchanged in VIII)
	base_exception GARCHOMP, PLAIN_FORM, 270 ; BST x 50.0% as of gen V (unchanged in VIII)
	...
	base_exception GENESIS_MON, PLAIN_FORM, 390
	dw -1
