...
; entries correspond to constants/pokemon_constants.asm
	...
	body_data   7,  306, HEAD_ARMS,    BLACK  ; SPOINK
	body_data   9,  715, BIPEDAL_TAIL, PURPLE ; GRUMPIG
	...
	body_data  20, 1000, QUADRUPED,    GREEN  ; TROPIUS
	...
	body_data   6,  421, BIPEDAL,      BLUE   ; BAGON
	body_data  11, 1105, QUADRUPED,    WHITE  ; SHELGON
	body_data  15, 1026, QUADRUPED,    BLUE   ; SALAMENCE
	...
	body_data   4,   55, BIPEDAL_TAIL, BROWN  ; BUNEARY
	body_data  12,  333, BIPEDAL_TAIL, BROWN  ; LOPUNNY
	body_data   9,   44, HEAD,         PURPLE ; MISMAGIUS
	body_data   9,  273, WINGS,        BLACK  ; HONCHKROW
	body_data   5,  605, HEAD,         GREEN  ; BRONZOR
	...
	body_data   8,  120, INSECTOID,    PURPLE ; SKORUPI
	...
	body_data  15,  582, QUADRUPED,    BLUE   ; SAMUROTT (HISUIAN_FORM)
	body_data  12,  192, BIPEDAL,      GREEN  ; LILLIGANT (HISUIAN_FORM)
	body_data   7,  125, QUADRUPED,    GRAY   ; ZORUA (HISUIAN_FORM)
	body_data  16,  730, BIPEDAL_TAIL, GRAY   ; ZOROARK (HISUIAN_FORM)
	...
	body_data  10,  180, FINS,         GREEN  ; BASCULIN (BASCULIN_BLUE_FORM)
	
	body_data  13,  929, QUADRUPED,    BLUE   ; DARMANITAN (DARMANITAN_ZEN_FORM)
	body_data  17, 1200, QUADRUPED,    WHITE  ; DARMANITAN (DARMANITAN_GALARIAN_ZEN_FORM)
	
	body_data   6,  195, QUADRUPED,    GREEN  ; DEERLING (DEERLING_SUMMER_FORM)
	body_data   6,  195, QUADRUPED,    RED    ; DEERLING (DEERLING_AUTUMN_FORM)
	body_data   6,  195, QUADRUPED,    BROWN  ; DEERLING (DEERLING_WINTER_FORM)
	
	body_data  19,  925, QUADRUPED,    BROWN  ; SAWSBUCK (DEERLING_SUMMER_FORM)
	body_data  19,  925, QUADRUPED,    BROWN  ; SAWSBUCK (DEERLING_AUTUMN_FORM)
	body_data  19,  925, QUADRUPED,    BROWN  ; SAWSBUCK (DEERLING_WINTER_FORM)
	
	body_data  12,  330, TENTACLES,    WHITE  ; FRILLISH (FRILLISH_FEMALE_FORM)
	body_data  22, 1350, TENTACLES,    WHITE  ; JELLICENT (JELLICENT_FEMALE_FORM)
