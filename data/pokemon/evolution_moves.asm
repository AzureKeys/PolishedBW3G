EvolutionMoves::
	...
	db NO_MOVE      ; STUNFISK, GALARIAN_FORM

	db NO_MOVE      ; GROWLITHE, HISUIAN_FORM
	db EXTREMESPEED ; ARCANINE, HISUIAN_FORM
	db NO_MOVE      ; SNEASEL, HISUIAN_FORM
	db NIGHT_SLASH  ; SAMUROTT, HISUIAN_FORM (Ceaseless Edge → LA move)
	db DRAIN_PUNCH  ; LILLIGANT, HISUIAN_FORM (Victory Dance → LA move)
	db NO_MOVE      ; ZORUA, HISUIAN_FORM
	db SHADOW_CLAW  ; ZOROARK, HISUIAN_FORM
	db PSYCHIC_M    ; BRAVIARY, HISUIAN_FORM (Esper Wing → TM move)
