	...
	tilecoll WALL, WINDOW, FLOOR, FLOOR ; 3a
	...
	tilecoll WALL, WINDOW, FLOOR, FLOOR ; 9e
	tilecoll FLOOR, FLOOR, WARP_CARPET_DOWN, WARP_CARPET_DOWN ; 9f
	tilecoll WALL, WALL, FRIDGE, WALL ; a0
