...
DecorationAttributes:
	...
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_BULBASAUR_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_CHARMANDER_DOLL,         SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_SQUIRTLE_DOLL,           SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_CHIKORITA_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_CYNDAQUIL_DOLL,          SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_TOTODILE_DOLL,           SPRITE_MON_DOLL_1
	...
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_MAGIKARP_DOLL,           SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_ODDISH_DOLL,             SPRITE_MON_DOLL_1
	...
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_VOLTORB_DOLL,            SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_ABRA_DOLL,               SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_UNOWN_DOLL,              SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     GEODUDE,           SET_UP_DOLL,        EVENT_DECO_GEODUDE_DOLL,            SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_PINECO_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     MARILL,            SET_UP_DOLL,        EVENT_DECO_MARILL_DOLL,             SPRITE_MON_DOLL_1
	decoration DECO_DOLL,     RATTATA,           SET_UP_DOLL,        EVENT_DECO_TEDDIURSA_DOLL,          SPRITE_MON_DOLL_1
