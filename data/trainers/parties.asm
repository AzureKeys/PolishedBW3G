...
BrockGroup:
	...
	tr_mon 63, RATTATA @ EVIOLITE
		...
		tr_moves TACKLE, ROCK_SLIDE, EARTHQUAKE, OUTRAGE
	tr_mon 65, RATTATA
	...
	tr_mon 73, RATTATA @ KINGS_ROCK
		tr_moves TACKLE, ROCK_SLIDE, EARTHQUAKE, MEGAHORN
	tr_mon 72, RATTATA @ MYSTIC_WATER
		tr_moves ANCIENTPOWER, SURF, EARTH_POWER, SPIKES
	tr_mon 72, RATTATA @ MIRACLE_SEED
		tr_moves SLASH, SURF, ENDURE, GIGA_DRAIN
	tr_mon 73, RATTATA @ QUICK_CLAW
...
MistyGroup:
	...
	tr_mon 60, RATTATA
		...
		tr_moves DEFENSE_CURL, STOMP, PROTECT, TACKLE
	tr_mon 62, LANTURN
	...
	tr_mon 72, RATTATA @ KINGS_ROCK
		tr_moves SWORDS_DANCE, TACKLE, X_SCISSOR, ROCK_SLIDE
...
LtSurgeGroup:
	...
	tr_mon 74, ELECTIVIRE @ BLACK_BELT
		tr_moves TACKLE, THUNDERPUNCH, LIGHT_SCREEN, WILD_CHARGE
...
JanineGroup:
	...
	tr_mon 62, RATTATA
		...
		tr_moves AQUA_TAIL, POISON_JAB, SPIKES, TACKLE
	tr_mon 64, NIDOQUEEN
...
BlueGroup:
	...
	tr_mon 66, RATTATA @ BLACK_BELT
		tr_moves DYNAMICPUNCH, EARTHQUAKE, STONE_EDGE, THUNDERPUNCH
	tr_mon 67, RATTATA @ HARD_STONE
...
endc
	...
	tr_mon 74, UMBREON @ BRIGHTPOWDER
		tr_moves CONFUSE_RAY, TOXIC, FEINT_ATTACK, PROTECT
	tr_mon 73, RATTATA @ BLACK_BELT
		tr_moves TACKLE, EARTHQUAKE, STONE_EDGE, THUNDERPUNCH
	tr_mon 74, RATTATA @ HARD_STONE
		tr_moves SLASH, SURF, STONE_EDGE, GIGA_DRAIN
...
LeafGroup:
	...
	tr_mon 98, RATTATA @ MUSCLE_BAND, FEMALE
		tr_extra HUSTLE, ATK_UP_SATK_DOWN
		tr_moves HONE_CLAWS, CRUNCH, EARTHQUAKE, ROCK_SLIDE
	tr_mon 99, RATTATA @ WISE_GLASSES, FEMALE
if DEF(FAITHFUL)
		tr_extra HUSTLE, SATK_UP_ATK_DOWN
...
BugCatcherGroup:
	...
	tr_mon 25, RATTATA
		tr_moves FURY_STRIKES, FOCUS_ENERGY, PIN_MISSILE, THRASH
	tr_mon 24, RATTATA
	...
	tr_mon 28, RATTATA
		tr_moves DISABLE, SUPERSONIC, CONFUSION, TACKLE
	end_trainer

	def_trainer ARNIE4, "Arnie"
	tr_mon 36, RATTATA
		tr_moves GUST, SUPERSONIC, PSYBEAM, TACKLE
	end_trainer
...
endc
	...
	tr_mon 31, CLEFAIRY
		tr_moves ENCORE, SING, TRI_ATTACK, TACKLE
	end_trainer

	def_trainer TIFFANY2, "Tiffany"
	tr_mon 40, CLEFAIRY
		tr_moves REFLECT, TRI_ATTACK, TACKLE, TACKLE
	end_trainer

	def_trainer TIFFANY3, "Tiffany"
	tr_mon 44, CLEFABLE
		tr_moves TACKLE, ENCORE, HEALINGLIGHT, TACKLE
	end_trainer

	def_trainer TIFFANY4, "Tiffany"
	tr_mon 49, CLEFABLE
		tr_moves HEALINGLIGHT, TRI_ATTACK, TACKLE, TACKLE
	end_trainer
...
BirdKeeperGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 4, RATTATA
		tr_moves GUST, QUICK_ATTACK, THRASH, MUD_SLAP
	tr_mon LEVEL_FROM_BADGES + 4, RATTATA
		tr_moves GUST, QUICK_ATTACK, THRASH, DOUBLE_TEAM
...
PokemaniacGroup:
	...
	tr_mon 47, RATTATA
		tr_moves ROLLOUT, ATTRACT, RETURN, TACKLE
	end_trainer
...
SuperNerdGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 9, SEADRA
		tr_moves TACKLE, OUTRAGE, SURF, WATERFALL
	end_trainer
...
BeautyGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 9, RATTATA, MALE
...
BreederGroup:
	...
	tr_mon 27, RATTATA @ EVIOLITE
		tr_moves TACKLE, THRASH, FORESIGHT, HI_JUMP_KICK
	tr_mon 28, MUNCHLAX @ EVIOLITE
		tr_moves TACKLE, BODY_SLAM, SCREECH, GUNK_SHOT
...
SailorGroup:
	...
	tr_mon 38, POLITOED
		tr_moves TACKLE, RAIN_DANCE, BODY_SLAM, PERISH_SONG
	tr_mon 38, POLIWRATH
