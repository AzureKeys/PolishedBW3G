...
CaitlinGroup:
	...
	tr_mon 69, GALLADE @ WHITE_HERB
		...
		tr_dvs 0 Spe
		tr_evs 196 HP, 252 Atk
		tr_moves CLOSE_COMBAT, ZEN_HEADBUTT, SHADOW_SNEAK, TRICK_ROOM
	tr_mon 69, METAGROSS @ ROOM_SERVICE
		tr_extra CLEAR_BODY, ATK_UP_SPE_DOWN
		tr_dvs 0 Spe
		tr_evs 252 HP, 196 Atk
		tr_moves IRON_HEAD, ZEN_HEADBUTT, KNOCK_OFF, BULLET_PUNCH
	...
	tr_mon 73, REUNICLUS @ LIFE_ORB
		...
		tr_dvs 0 Spe
		tr_evs 252 HP, 196 Def
		tr_moves PSYSHOCK, FOCUS_BLAST, ENERGY_BALL, TRICK_ROOM 
	end_trainer
