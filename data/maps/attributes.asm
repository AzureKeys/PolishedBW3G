...
ENDM
	...
	map_attributes Route17, ROUTE_17, $65, WEST
	connection west, Route18, ROUTE_18, 1
	...
	map_attributes CasteliaParkTunnel, CASTELIA_PARK_TUNNEL, $0, 0
	map_attributes CasteliaPark, CASTELIA_PARK, $0, 0
