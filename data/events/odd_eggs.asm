...
OddEggs:
	...
	dp RATTATA, IS_EGG_MASK | PLAIN_FORM
	db TACKLE, THRASH, FORESIGHT, DIZZY_PUNCH
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality
	...
	dp RATTATA, IS_EGG_MASK | PLAIN_FORM
	db THRASH, TACKLE, TACKLE, DIZZY_PUNCH
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality

	dp MUNCHLAX, IS_EGG_MASK | PLAIN_FORM
	db SWEET_KISS, TACKLE, TACKLE, DIZZY_PUNCH
	db $BB, $BB, $BB ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality
...
MystriEgg:
	...
	db GROWL, CHARM, MOONBLAST, TACKLE
	db $FF, $FF, $FF ; DVs
	db SHINY_MASK | HIDDEN_ABILITY | QUIRKY ; Personality
