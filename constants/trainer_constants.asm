...
DEF BETA EQU __trainer_class__
	...
	const GENTLEMAN_R3
	const GENTLEMAN_R2
	const GENTLEMAN_CELESTIAL_TOWER_1
	const GENTLEMAN_CELESTIAL_TOWER_2
	...
	const SOCIALITE_R3
	const SOCIALITE_R2
	const SOCIALITE_CELESTIAL_TOWER_1
	const SOCIALITE_CELESTIAL_TOWER_2
