...
; SpriteMovementData indexes (see data/sprites/map_objects.asm)
	...
	const SPRITEMOVEDATA_SPINARAK_CART        ; 3c
...
; StepFunction_FromMovement.Pointers indexes (see engine/overworld/map_objects.asm)
	...
	const SPRITEMOVEFN_BRIDGE_RAIL_LEFT      ; 20
	const SPRITEMOVEFN_BRIDGE_RAIL_RIGHT     ; 21
	const SPRITEMOVEFN_BADGE_1               ; 23
	const SPRITEMOVEFN_BADGE_2               ; 24
	const SPRITEMOVEFN_BADGE_3               ; 25
	const SPRITEMOVEFN_MARVELOUS_LEFT_1      ; 26
	const SPRITEMOVEFN_MARVELOUS_LEFT_2      ; 27
	const SPRITEMOVEFN_MARVELOUS_RIGHT_1     ; 28
	const SPRITEMOVEFN_MARVELOUS_RIGHT_2     ; 29
...
; ObjectActionPairPointers indexes (see engine/overworld/map_object_action.asm)
	...
	const OBJECT_ACTION_BRIDGE_RAIL_LEFT ; 1d
	const OBJECT_ACTION_BRIDGE_RAIL_RIGHT ; 1e
	const OBJECT_ACTION_BADGE_1          ; 20
	const OBJECT_ACTION_BADGE_2          ; 21
	const OBJECT_ACTION_BADGE_3          ; 22
	const OBJECT_ACTION_MARVELOUS_LEFT_1 ; 23
	const OBJECT_ACTION_MARVELOUS_LEFT_2 ; 24
	const OBJECT_ACTION_MARVELOUS_RIGHT_1 ; 25
	const OBJECT_ACTION_MARVELOUS_RIGHT_2 ; 26
...
; Facings indexes (see data/sprites/facings.asm)
	...
	const FACING_BRIDGE_RAIL_LEFT   ; 3e
	const FACING_BRIDGE_RAIL_RIGHT  ; 3f
	const FACING_ADMIN_MEOWTH       ; 40
	const FACING_BADGE_1            ; 41
	const FACING_BADGE_2            ; 42
	const FACING_BADGE_3            ; 43
	const FACING_MARVELOUS_LEFT_1   ; 44
	const FACING_MARVELOUS_LEFT_2   ; 45
	const FACING_MARVELOUS_RIGHT_1  ; 46
	const FACING_MARVELOUS_RIGHT_2  ; 47
