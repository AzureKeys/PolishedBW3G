...
DEF NUM_GRASSMON EQU 10 ; data/wild/*_grass.asm table size
DEF NUM_WATERMON EQU 3 ; data/wild/*_water.asm table size

DEF GRASS_WILDDATA_LENGTH EQU 2 + 1 + NUM_GRASSMON * 3 * 3
DEF WATER_WILDDATA_LENGTH EQU 2 + 1 + NUM_WATERMON * 3
DEF FISHGROUP_DATA_LENGTH EQU 2 + 2 * 3

DEF NUM_ROAMMON_MAPS EQU 0 ; RoamMaps table size (see data/wild/roammon_maps.asm)
...
; happiness change events (see data/events/happiness_changes.asm)
DEF HAPPINESS_THRESHOLD_1 EQU 100
DEF HAPPINESS_THRESHOLD_2 EQU 160
; affection bonuses (see data/battle/affection_thresholds.asm)
DEF AFFECTION_THRESHOLD_1 EQU 180
DEF AFFECTION_THRESHOLD_2 EQU 220
