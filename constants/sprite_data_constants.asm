...
; OvercastOBPalette indexes (see gfx/overworld/npc_sprites_overcast.pal)
	...
	ow_npc_pal_const RED_D             ; 04
	ow_npc_pal_const BLUE_D            ; 05
	ow_npc_pal_const GREEN_D           ; 06
	ow_npc_pal_const PURPLE            ; 07
	ow_npc_pal_const GRAY              ; 08
	ow_npc_pal_const PINK              ; 09
	ow_npc_pal_const TEAL              ; 0a
	ow_npc_pal_const YELLOW            ; 0b
	ow_npc_pal_const ORANGE            ; 0c
	ow_npc_pal_const AZURE             ; 0d
	ow_npc_pal_const WHITE             ; 0e
	ow_npc_pal_const BLACK             ; 0f
	ow_npc_pal_const PURPLE_D          ; 10
...
; SingleObjectPals indexes (see gfx/overworld/npc_single_object.pal)
	ow_npc_pal_const EMOTE_GRAY        ; 18
	ow_npc_pal_const EMOTE_BLACK       ; 19
	ow_npc_pal_const EMOTE_GREEN       ; 1a
	ow_npc_pal_const EMOTE_PURPLE      ; 1b
	ow_npc_pal_const EMOTE_RED         ; 1c
	ow_npc_pal_const EMOTE_ORANGE      ; 1d
	ow_npc_pal_const EMOTE_BLUE        ; 1e
	ow_npc_pal_const ELECTRIC_FENCE    ; 1f
	ow_npc_pal_const LIGHTNING_CRYSTAL ; 20
	ow_npc_pal_const ROCK_CRYSTAL      ; 21
	ow_npc_pal_const N64               ; 22
	ow_npc_pal_const POKECOM_SIGN      ; 23
	ow_npc_pal_const RANGI             ; 24
	ow_npc_pal_const DRILL             ; 25
	ow_npc_pal_const PEARL             ; 26
	ow_npc_pal_const TINY_WINDOW       ; 27
