RelicCastleB3F_MapScriptHeader:
	...
	def_object_events
	object_event  8,  7, SPRITE_ICE_BOULDER_FOSSILS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, 0, OBJECTTYPE_SCRIPT, 0, RelicCastleB3FCoverFossilScript, EVENT_RELIC_CASTLE_B3F_COVER_FOSSIL
	object_event  9,  7, SPRITE_ICE_BOULDER_FOSSILS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, 0, OBJECTTYPE_SCRIPT, 0, RelicCastleB3FPlumeFossilScript, EVENT_RELIC_CASTLE_B3F_PLUME_FOSSIL
