MarlonsHouse_MapScriptHeader:
	...
	object_event  3,  2, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_KEY_ITEM, OBJECTTYPE_SCRIPT, 0, SnivyPokeballScript, EVENT_MARLONS_HOUSE_SNIVY_BALL
	object_event  4,  2, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_SCRIPT, 0, TepigPokeballScript, EVENT_MARLONS_HOUSE_TEPIG_BALL
	object_event  5,  2, SPRITE_BALL_CUT_FRUIT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_DECO_ITEM, OBJECTTYPE_SCRIPT, 0, OshawottPokeballScript, EVENT_MARLONS_HOUSE_OSHAWOTT_BALL
