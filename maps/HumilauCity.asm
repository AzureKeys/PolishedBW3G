HumilauCity_MapScriptHeader:
	...
	object_event  3, 28, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_DARK_RED, OBJECTTYPE_COMMAND, jumptext, HumilauPCBlockerText, EVENT_HUMILAU_CITY_PC_BLOCKER
	object_event  8, 24, SPRITE_ACE_TRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, HumilauGymBlockerText, EVENT_HUMILAU_CITY_GYM_BLOCKER
	object_event 17, 30, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_BROWN, OBJECTTYPE_COMMAND, jumptextfaceplayer, HumilauMarineTubeBlockerText, EVENT_HUMILAU_CITY_MARINE_TUBE_BLOCKER
	...
	object_event 17, 16, SPRITE_FISHER, SPRITEMOVEDATA_WANDER, 2, 2, -1, PAL_NPC_DARK_BLUE, OBJECTTYPE_COMMAND, jumptextfaceplayer, HumilauCityFisherText, -1
	...
	object_event 24,  8, SPRITE_TEACHER, SPRITEMOVEDATA_WANDER, 1, 3, -1, PAL_NPC_DARK_BLUE, OBJECTTYPE_COMMAND, jumptextfaceplayer, HumilauCityTeacherText, -1
