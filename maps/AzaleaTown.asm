AzaleaTown_MapScriptHeader:
	...
	pokemon_event 14, 12, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_BLUE, AzaleaTownWoosterText, EVENT_SLOWPOKE_WELL_SLOWPOKES
	pokemon_event 14, 12, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_BLUE, AzaleaTownWoosterText, EVENT_AZALEA_TOWN_SLOWPOKES
