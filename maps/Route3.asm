Route3_MapScriptHeader:
	...
	def_object_events
	object_event 38,  7, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_BLUE_D, OBJECTTYPE_SCRIPT, 0, Route3DayCareManScript, EVENT_ROUTE_3_DAY_CARE_MAN
	...
	object_event 30, 27, SPRITE_RANGER_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, PAL_NPC_RED_D, OBJECTTYPE_GENERICTRAINER, 2, TrainerPkmnRangerMR3, -1
	...
	object_event 21, 36, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_BLUE_D, OBJECTTYPE_GENERICTRAINER, 0, TrainerFisher2R3, -1
