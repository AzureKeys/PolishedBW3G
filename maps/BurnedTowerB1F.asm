BurnedTowerB1F_MapScriptHeader:
	...
	def_object_events
	pokemon_event  7,  3, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_BROWN, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_1
	pokemon_event 12,  3, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_RED, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_1
	pokemon_event 10,  4, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_BLUE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_1
	pokemon_event  7,  3, RATTATA, SPRITEMOVEDATA_STILL, -1, PAL_NPC_WHITE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
	pokemon_event 12,  3, RATTATA, SPRITEMOVEDATA_STILL, -1, PAL_NPC_WHITE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
	pokemon_event 10,  4, RATTATA, SPRITEMOVEDATA_STILL, -1, PAL_NPC_WHITE, ClearText, EVENT_BURNED_TOWER_B1F_BEASTS_2
