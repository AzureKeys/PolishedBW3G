StriatonPokecenter_MapScriptHeader:
	...
	object_event  1,  4, SPRITE_RANGER_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, PAL_NPC_RED_D, OBJECTTYPE_COMMAND, jumptextfaceplayer, StriatonPokecenterRangerFText, -1
	...
	object_event  1,  7, SPRITE_LADY, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, PAL_NPC_PURPLE_D, OBJECTTYPE_COMMAND, jumptextfaceplayer, StriatonPokecenterLadyText, -1
