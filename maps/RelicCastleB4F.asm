RelicCastleB4F_MapScriptHeader:
	...
	object_event  8,  8, SPRITE_ICE_BOULDER_FOSSILS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, 0, OBJECTTYPE_ITEMBALL, PLAYEREVENT_ITEMBALL, COVER_FOSSIL, 1, EVENT_RELIC_CASTLE_B4F_COVER_FOSSIL
	object_event  9,  8, SPRITE_ICE_BOULDER_FOSSILS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, 0, OBJECTTYPE_ITEMBALL, PLAYEREVENT_ITEMBALL, PLUME_FOSSIL, 1, EVENT_RELIC_CASTLE_B4F_PLUME_FOSSIL
