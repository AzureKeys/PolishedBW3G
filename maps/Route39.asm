Route39_MapScriptHeader:
	...
	pokemon_event  3, 26, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_PINK, Route39MiltankText, -1
	pokemon_event  6, 25, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_PINK, Route39MiltankText, -1
	pokemon_event  4, 29, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_PINK, Route39MiltankText, -1
	pokemon_event  8, 27, RATTATA, SPRITEMOVEDATA_POKEMON, -1, PAL_NPC_PINK, Route39MiltankText, -1
