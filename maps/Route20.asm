Route20_MapScriptHeader:
	...
	object_event 30, 21, SPRITE_SCHOOLGIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, PAL_NPC_DARK_RED, OBJECTTYPE_TRAINER, 3, TrainerSchoolKidF1R20, -1
	object_event 21, 11, SPRITE_SCHOOLGIRL, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, PAL_NPC_DARK_RED, OBJECTTYPE_TRAINER, 3, TrainerSchoolKidF2R20, -1
	object_event 33,  9, SPRITE_SCHOOLGIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_DARK_RED, OBJECTTYPE_TRAINER, 2, TrainerSchoolKidF3R20, -1
	...
	fruittree_event  7,  5, FRUITTREE_ROUTE_20, PECHA_BERRY, PAL_NPC_PINK
