Route5_MapScriptHeader:
	...
	object_event 22, 15, SPRITE_ACE_TRAINER_M, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, PAL_NPC_DARK_GREEN, OBJECTTYPE_TRAINER, 3, TrainerDancer1R5, -1
	object_event 20, 10, SPRITE_ACE_TRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, PAL_NPC_DARK_GREEN, OBJECTTYPE_GENERICTRAINER, 3, TrainerDancer2R5, -1
...
.ChooseRematch:
	...
	iftruefwd .LoadFight5
	checkmapscene SEASIDE_CAVE_CHAMBER
	ifequalfwd 1, .LoadFight4
