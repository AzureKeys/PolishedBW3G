...
'unova_north': 'Route9 Route23East Route23West',
'unova_house': 'PlayersHouse1F PlayersHouse2F MarlonsHouse CaitlinsHouse CasteliaTradeHouse1 CasteliaTradeHouse2 CasteliaGameFreak AspertiaMomHouse Route3DayCare NuvemaMomHouse DriftveilShelter DraydensHouse1F DraydensHouse2F IcirrusFanClub',
'traditional_house': 'StrangeHouse1F StrangeHouseB1F StrangeHouseRooms DreamyardB1F CelestialTower1F CelestialTower CelestialTowerRoof LentimasGym LentimasAirport AldersHouse FloccesyRanchBarn',
'gate': 'LentimasLostlornGate Route4NimbasaGate CasteliaSkyarrowBridgeGate BattleCompany1F BattleCompany2F PinwheelSkyarrowBridgeGate NacreneMuseum StriatonLab DriftveilStoneEmporium',
'magnet_train': 'NimbasaSubway AspertiaSubway OpelucidBattleHouse',
'champions_room': 'CasteliaBikeShop AspertiaGym NsRoom ChampionsRoom HallOfFame',
...
'cave': 'GiantChasm1F GiantChasmRooms ReversalMountain1F ReversalMountainB1F WellspringCave1F WellspringCaveB1F RelicPassageFront RelicPassageBack MistraltonCave1F MistraltonCave2F MistraltonCave3F ChargestoneCave1F ChargestoneCaveB1F ChargestoneCaveB2F SeasideCave1F SeasideCaveB1F SeasideCaveChamber VictoryRoadCave2F VictoryRoadCave3F TwistMountainEntrance TwistMountain1F TwistMountain2F TwistMountain3F TwistMountainB1F TwistMountainGenesectRoom',
'cave_ruins': 'VictoryRoadCave1F VictoryRoadCastle TwistMountainOutside',
'ice_path': 'SeasideCaveB2F IcirrusCave',
'elite_four_room': 'MarineTubeEntrance MistraltonGym1F MistraltonGym2F MarshalsRoom GrimsleysRoom ElesasRoom ColresssRoom',
'lentimas': 'LentimasOutskirt LentimasTown',
'forest': 'LostlornForest PinwheelForest VictoryRoadGrove',
...
'dreamyard': 'Dreamyard VictoryRoadOutdoor1F VictoryRoadOutdoor2F',
...
'pkmn_league': 'VictoryRoadEntranceSouthEast VictoryRoadEntranceSouthWest VictoryRoadEntranceNorthConnectionDummy VictoryRoadEntranceNorth PkmnLeagueEntrance PkmnLeagueMain ChampionsRoomEntrance',
}
